"""
Django settings for vinsetcepages project.
...
SECRET_KEY = "django-insecure-%5$5u$gx$i@7=#z)r+c+awwk$m)d3c7n3og2-m#n2$lc=%&hut"
...
ROOT_URLCONF = "vinsetcepages.urls"

TEMPLATES = [
    {
        "BACKEND": "django.template.backends.django.DjangoTemplates",
        "DIRS": [str(BASE_DIR.joinpath('templates'))], # lien template
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
WSGI_APPLICATION = "vinsetcepages.wsgi.application"
